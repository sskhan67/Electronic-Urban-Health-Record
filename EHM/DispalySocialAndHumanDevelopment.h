...
namespace EHM {
	...
	/// <summary>
	/// Summary for DispalySocialAndHumanDevelopment
	/// </summary>
	public ref class DispalySocialAndHumanDevelopment : public System::Windows::Forms::Form
	{
	public:
		DispalySocialAndHumanDevelopment(void)
		{
			InitializeComponent();
			//
	...
	protected:
		...
		/// </summary>
		~DispalySocialAndHumanDevelopment()
		{
			if (components)
			{
				delete components;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnClose->Click += gcnew System::EventHandler(this, &DispalySocialAndHumanDevelopment::btnClose_Click);
			// 
			// btnUpdate
			// 
			...
			this->btnUpdate->Click += gcnew System::EventHandler(this, &DispalySocialAndHumanDevelopment::btnUpdate_Click);
			// 
			// XMLdataGridView
			// 
			...
			this->label3->Size = System::Drawing::Size(596, 30);
			this->label3->TabIndex = 90;
			this->label3->Text = L"Social and human development Data For All Cities";
			// 
			// label4
			// 
			...
			this->ClientSize = System::Drawing::Size(1370, 712);
			...
			this->Name = L"DispalySocialAndHumanDevelopment";
			this->Text = L"DispalySocialAndHumanDevelopment";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->Load += gcnew System::EventHandler(this, &DispalySocialAndHumanDevelopment::DispalySocialAndHumanDevelopment_Load);
...
#pragma endregion
	...
	private: System::Void DispalySocialAndHumanDevelopment_Load(System::Object^  sender, System::EventArgs^  e) {
		pictureBox1->Image = Image::FromFile("logo_uni.png");
		pictureBox2->Image = Image::FromFile("kbs_transparent.png");
		try
		{
			mydoc.DataSet->ReadXml("..\\App_Data\\Social.xml");
			XMLdataGridView->DataSource = mydoc.DataSet->DefaultViewManager;
			XMLdataGridView->DataMember = "Social";
	...
	private: System::Void btnUpdate_Click(System::Object^  sender, System::EventArgs^  e) {
		mydoc.DataSet->WriteXml("..\\App_Data\\Social.xml");
