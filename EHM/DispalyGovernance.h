...
namespace EHM {
	...
	/// <summary>
	/// Summary for DispalyGovernance
	/// </summary>
	public ref class DispalyGovernance : public System::Windows::Forms::Form
	{
	public:
		DispalyGovernance(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnClose->Click += gcnew System::EventHandler(this, &DispalyGovernance::btnClose_Click);
			// 
			// btnUpdate
			// 
			...
			this->btnUpdate->Click += gcnew System::EventHandler(this, &DispalyGovernance::btnUpdate_Click);
			// 
			// XMLdataGridView
			// 
			...
			this->label3->Size = System::Drawing::Size(378, 30);
			this->label3->TabIndex = 21;
			this->label3->Text = L"Governance  Data For All Cities";
			// 
			// label4
			// 
			...
			this->Name = L"DispalyGovernance";
			this->Text = L"DispalyGovernance";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->Load += gcnew System::EventHandler(this, &DispalyGovernance::DispalyGovernance_Load);
...
#pragma endregion
	...
	private: System::Void DispalyGovernance_Load(System::Object^  sender, System::EventArgs^  e) {
		pictureBox1->Image = Image::FromFile("logo_uni.png");
		pictureBox2->Image = Image::FromFile("kbs_transparent.png");
		try
		{
			mydoc.DataSet->ReadXml("..\\App_Data\\Governance.xml");
			XMLdataGridView->DataSource = mydoc.DataSet->DefaultViewManager;
			XMLdataGridView->DataMember = "Governance";
	...
	private: System::Void btnUpdate_Click(System::Object^  sender, System::EventArgs^  e) {
		mydoc.DataSet->WriteXml("..\\App_Data\\Governance.xml");
